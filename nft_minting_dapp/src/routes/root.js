...
export const StyledButton = styled.button`
  ...
  width: 190px;
  cursor: pointer;
  box-shadow: 0px 2px 4px #00474a;
  -webkit-box-shadow: 0px 2px 4px #00474a;
  -moz-box-shadow: 0px 2px 4px #00474a;
  :active {
    box-shadow: none;
      ...
      <s.Container
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }}>
          ...
          <s.Container
            ...
            <s.Animation>
              <s.Container flex={1} jc={"center"} ai={"center"}>
                <StyledImg alt={"example"} src={"/config/images/main-image.png"} />
              </s.Container>
            </s.Animation>
            <s.SpacerMedium />
            <s.Animation>
